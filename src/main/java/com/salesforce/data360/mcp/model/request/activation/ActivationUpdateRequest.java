...
/**
 * Request to update an activation.
...
public class ActivationUpdateRequest {
    ...
    @McpToolParam(description = "Refresh type (e.g., FULL, INCREMENTAL)", required = false)
    ...
    @McpToolParam(description = "Curated entity configuration", required = false)
    private CuratedEntityInput curatedEntity;

    @McpToolParam(description = "Activation target subject configuration", required = false)
    private ActivationTargetSubjectConfigInput activationTargetSubjectConfig;

    @McpToolParam(description = "Attribute limiting expression configuration", required = false)
    private AttributeLimitingExpressionConfigInput attributeLimitingExpressionConfig;

    @McpToolParam(description = "Array of data source configurations", required = false)
