...
/**
 * Mirrors {@code ResourceFiltersInputRepresentation}.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ResourceFiltersInput {

    @McpToolParam(description = "These include extractAttributes and parser settings where applicable")
