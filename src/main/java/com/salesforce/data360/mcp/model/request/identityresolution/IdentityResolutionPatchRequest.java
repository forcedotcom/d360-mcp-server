...
/**
 * Request body for patching an Identity Resolution ruleset.
 * All fields are optional for partial updates.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class IdentityResolutionPatchRequest {

    @McpToolParam(description = "Label of the ruleset", required = false)
    private String label;

    @McpToolParam(description = "Configuration type: Account or Individual", required = false)
    ...
    @McpToolParam(description = "Array of reconciliation rule objects: [{entityName, ruleType, shouldIgnoreEmptyValue, fields: [{fieldName, ruleType, shouldIgnoreEmptyValue, sources: [{name}]}]}]", required = false)
