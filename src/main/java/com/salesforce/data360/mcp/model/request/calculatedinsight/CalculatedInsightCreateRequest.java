...
/**
 * Request body for creating a Calculated Insight.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CalculatedInsightCreateRequest {

    @NotBlank
    @McpToolParam(description = "API name for the calculated insight (must end with __cio)")
